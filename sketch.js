...
function setup() {
	...
	leftSide = new Ground(1050,600,10,120);
	rightSide = new Ground(1220,600,10,120);
	bottomSide = new Ground(1135,650,150,20);
	pap1= new Paper(500,300,50,50)
...
function keyPressed() {
	...
	Matter.Body.applyForce(pap1.paper,pap1.paper.position,{x:0.1,y:-0.1})
  	}
}
